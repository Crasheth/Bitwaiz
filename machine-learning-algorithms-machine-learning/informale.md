...
*   **Alberi Decisionali:** Pensa a un albero che prende decisioni basate su una serie di domande. Gli alberi decisionali suddividono i dati in sottogruppi, creando una struttura ad albero per classificare o prevedere risultati.
*   **Support Vector Machines (SVM):** Immagina di voler separare due gruppi di punti in uno spazio bidimensionale. Le SVM trovano l'iperpiano che massimizza la distanza tra i gruppi, creando una barriera efficace.
*   **k-Nearest Neighbors (k-NN):**  Se ti trovi in un bosco e non sai quale sentiero seguire, puoi chiedere consiglio ai tuoi vicini più prossimi. k-NN funziona allo stesso modo: classifica un nuovo punto in base alla maggioranza dei suoi vicini più prossimi.
