...
*   **Integrazione SBAS-InSAR e Machine Learning:** Il metodo combina i dati di deformazione ottenuti tramite SBAS-InSAR con modelli di machine learning per una valutazione più completa della suscettibilità alle frane.
*   **Modelli di Machine Learning:** Vengono utilizzati modelli come random forest, logistic regression e gradient boosting decision tree, addestrati su fattori di rischio statici come l'altitudine, la pendenza, la litologia e l'attività umana.
*   **Valutazione tramite matrice di valutazione:** L'integrazione dei dati di deformazione avviene tramite una matrice di valutazione che confronta i livelli di intensità delle deformazioni con le classi di suscettibilità.
*   **Applicazione pratica:** Il metodo è stato applicato nella contea di Hualong, in Cina, per valutare il rischio di frane in una zona di transizione tra la Piana del Tibet e la Piana dell'Ordinaria.
