...
![NIS2 compliance](https://www.sealpath.com/wp-content/uploads/2023/09/nis2-compliance-checklist-roadmap.png)
...
1. **Verifica se sei soggetto al NIS2**: C’è un elenco dettagliato dei settori e delle dimensioni aziendali che devono aderire (es. aziende di energia, sanità).  
2. **Valuta le tue misure attuali**: Se hai già una buona conformità a GDPR o altre normative, puoi sfruttare alcuni aspetti comuni.  
3. **Implementa i 10 minimi requisiti** (es. valutazione dei rischi, piani di incidente).  
4. **Costruisci un piano per il compliance**: Ci vorranno circa 12 mesi per completare la conformità, con un’analisi, una consulenza e l’implementazione di strumenti.  
...
- [NIS2 Directive: securing network and information systems](https://digital-strategy.ec.europa.eu/en/policies/nis2-directive)
- [NIS2 requirements: A complete guide to compliance & implementation](https://www.dataguard.com/nis2/requirements/)
- [NIS2 Requirements | 10 Minimum Measures to Address](https://nis2directive.eu/nis2-requirements/)
- [NIS2 Directive: Complete Compliance Guide (2026)](https://www.legiscope.com/blog/nis2-compliance-guide.html)