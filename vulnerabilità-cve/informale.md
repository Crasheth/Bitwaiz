...
![vulnerabilità CVE](https://www.paloaltonetworks.it/content/dam/pan/en_US/images/cyberpedia/vulnerability-management/cve-identification-process.png)
...
Immagina che Google trovi una vulnerabilità di sicurezza nel suo software Chrome. Questa vulnerabilità verrà verificata e poi assegnata il CVE-2023-12345, con la descrizione completa disponibile su [CVE Details](https://cve.mitre.org/cve/).
...
- [Sicurezza delle applicazioni](https://www.redhat.com/it/topics/security/application-security)
- [Best practice per la gestione delle vulnerabilità](https://www.plexicus.ai/it/glossary/common-vulnerabilities-and-exposures-cve/)
- [Elenco di esempi di CVE](https://www.cvefind.com/it/faq.html)
- [Common Vulnerabilities and Exposures - Wikipedia](https://it.wikipedia.org/wiki/Common_Vulnerabilities_and_Exposures)
- [CVE (Common Vulnerabilities and Exposures) spiegato](https://www.plexicus.ai/it/glossary/common-vulnerabilities-and-exposures-cve/)
- [Cos'è un elenco CVE?](https://www.redhat.com/it/topics/security/what-is-cve)
- [FAQ – Domande su CVE, CWE e vulnerabilità | CVEFind](https://www.cvefind.com/it/faq.html)